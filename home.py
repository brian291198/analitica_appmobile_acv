...
#CONTAINERS CON ELEMENTOS
    ...
    cards = ft.Container( content=ft.Column([
                ...
                create_card("Segmentación de pacientes", "Clasificados bajo estilo de vida", "form_3", 2),
                create_card("Segmentación de pacientes", "Clasificados bajo factores médicos", "form_2", 3),
            ],
